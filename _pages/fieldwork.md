...
<div class="team-row" style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top: 1.0rem;">
  ...
  <div class="team-member" style="flex: 1 1 250px; text-align: center;">
    ...
    <p style="text-align: center; font-size: 0.7rem;">Ariel view of the R/V S.A. Agulhas II along the Punguin Akta ice shelf taken during the SO-CHIC Expedition in 2022.</p>
  </div>
...
<div class="team-row" style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-top: 1.0rem;">
  <div class="team-member" style="flex: 1 1 250px; text-align: center;">
    <video src="/images/2012-winter-cruise/SEAICE.mp4"
           style="width: 100%; max-width: 100%;
                  border-radius: 0;
                  object-fit: cover;
                  border: 1px solid #ccc; padding: 4px; box-sizing: border-box;"
